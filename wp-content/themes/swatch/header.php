...
?>
	...
	<?php if ( isset( $woo_options['woo_slider'] ) && $woo_options['woo_slider'] == 'true' && ( is_front_page() || is_home() ) && ! is_paged() ) { get_template_part( 'includes/featured' ); } // Load the Featured Slider ?>
